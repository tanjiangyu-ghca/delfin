...
class TestHpeMsaStorageDriver(TestCase):
    ...
    def test_list_masking_view(self, mock_ssh_get, mock_control, mock_port):
        mock_ssh_get.return_value = test_constans.ports_result
        mock_control.side_effect = {paramiko.SSHClient()}
        mock_port.side_effect = [test_constans.LIST_MAPS_ALL]
